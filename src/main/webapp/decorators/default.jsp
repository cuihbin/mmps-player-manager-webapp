...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<c:url value='/scripts/lib/plugins/jquery.treeview.css'/>" />
    <decorator:head/>
    ...
    <script type="text/javascript" src="<c:url value='/scripts/lib/plugins/jquery.treeview.js'/>"></script>
</head>
